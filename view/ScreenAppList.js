...
export default {
    ...
    setup(props) {
        const appListOnion = [
            ...
            {name: 'AdvanceMENU' ,         desc: 'Advanced emulator frontend' ,      icon: `${props.themeName}/icons/App/advancemenu.png`} ,
            {name: 'Clock' ,               desc: 'Set the current time' ,            icon: `${props.themeName}/icons/App/clock.png`} ,
            {name: 'Display Calibration' , desc: '240pSuite (Menu+Select to exit)' , icon: `${props.themeName}/icons/App/display.png`} ,
            {name: 'Ebook Reader' ,        desc: 'PixelReader v0.6' ,                icon: `${props.themeName}/icons/App/display.png`} ,
            {name: 'File Explorer' ,       desc: 'DinguxCommander' ,                 icon: `${props.themeName}/icons/App/filebrowser.png`} ,
            {name: 'Gallery' ,             desc: 'Screenshot viewer' ,               icon: `${props.themeName}/icons/App/gallery.png`} ,
            {name: 'GameSwitcher' ,        desc: 'Quickly switch games' ,            icon: `${props.themeName}/icons/App/gameswitcher.png`} ,
            {name: 'Music Player' ,        desc: 'GMU (Menu+Select to exit)' ,       icon: `${props.themeName}/icons/App/music.png`} ,
            {name: 'Onion OTA update' ,    desc: 'Update Onion over internet' ,      icon: `${props.themeName}/icons/App/pacman.png`} ,
            {name: 'PDF Reader' ,          desc: 'Green' ,                           icon: `${props.themeName}/icons/App/pdf.png`} ,
            {name: 'Quick Guide' ,         desc: 'Getting started with Onion' ,      icon: `${props.themeName}/icons/App/manual.png`} ,
            {name: 'Random Game' ,         desc: 'Launch random game (any system)' , icon: `${props.themeName}/icons/App/dice.png`} ,
            {name: 'Video Player' ,        desc: 'FFplay' ,                          icon: `${props.themeName}/icons/App/ffplay.png`} ,
